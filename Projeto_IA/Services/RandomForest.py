...
async def trainRandomForestRegressionDefault():
    ...
    # Salvar o modelo
    joblib.dump(randomForest, 'modelo_rf.zip')
    ...
    plt.tight_layout()
    plot_path = 'plot_randomForest/plot_importance_default.png'
    ...
    plot_path = 'plot_randomForest/plot_residual_default.png'
    plt.savefig(plot_path)
    plt.close()
    ...
    #plt.show()
    plot_path = 'plot_randomForest/plot_parity_default.png'
    plt.savefig(plot_path)
    plt.close()

    
async def trainRandomForestRegressionTuning():
    ...
    # Salvar o modelo
    joblib.dump(randomForest, 'modelo_rf_tuning.zip')
    ...
    plt.xticks(range(x.shape[1]), x.columns[indices], rotation=90)
    plt.tight_layout()
    plot_path = 'plot_randomForest/plot_importance_tuning.png'
    plt.savefig(plot_path)
    plt.close()
    ...
    plt.ylabel('Residuals')
    plt.title('Residual Plot')
    plot_path = 'plot_randomForest/plot_residual_tuning.png'
    plt.savefig(plot_path)
    plt.close()
    ...
    plt.title('Parity Plot')
    #plt.show()
    plot_path = 'plot_randomForest/plot_parity_tuning.png'
    plt.savefig(plot_path)
    plt.close()
